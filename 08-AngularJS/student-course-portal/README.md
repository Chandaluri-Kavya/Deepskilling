...
This is the one cumulative Angular 20 standalone project implementing all ten exercises in the supplied exercise book. HOL1–HOL10 are features of this portal, not separate Angular projects.
...
5. Use `npm test -- --watch=false --browsers=ChromeHeadless` for the included specs.

Real browser output captures are stored separately in `../Outputs/` under HOL06–HOL10. Earlier captures are stored in their respective HOL01–HOL05 `Outputs` folders.
...
| 10 | Course-card, HTTP service, and MockStore-connected course-list Jasmine specs |
